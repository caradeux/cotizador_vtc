...
else
{
			...
			mysqli_query($con, "insert into users (user_name, user_password_hash, user_email, date_added, user_group_id) values('$username','$user_password_hash','admin@admin.com','$date_added','1')");
