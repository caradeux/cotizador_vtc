                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class='fa fa-user'></i> <?php echo $_SESSION['user_name'];?></a>
                                    ...
                                    <li> 
                                        <div class="dw-user-box">
                                            ...
                                            <div class="u-text">
                                                ...
                                                <p class="text-muted"><?php echo $_SESSION['user_email'];?></p></div>
                                        </div>
                                    </li>
