                    ...
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><a href="cotizaciones.php"><i class="fa fa-list me-1"></i>Cotizaciones</a></li>
								<li class="breadcrumb-item active" aria-current="page">
                                    <i class="fa fa-edit me-1"></i>Editar #<?php echo $numero;?>
                                </li>
                            </ol>
                        </nav>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-3 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nombre_cliente" placeholder="Nombre del cliente" required value="<?php echo $cliente;?>">
                                        <input id="id_cliente" type='hidden' value="<?php echo $id_cliente;?>">
                                    </div>
                                    
                                    <div class="col-md-3 mb-3">
                                        <label for="atencion" class="form-label">
                                            <i class="fa fa-address-book me-1"></i>Atención
                                        </label>
                                        <select class='form-select' id="atencion" name="atencion" onchange="update_cotizacion(8,this.value);">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <label for="tel1" class="form-label">
                                            <i class="fa fa-phone me-1"></i>Teléfono de contacto
                                        </label>
                                        <input type="text" class="form-control" id="tel1" placeholder="Teléfono" value="<?php echo $telefono_contact;?>" readonly>
                                    </div>
                                    
                                    <div class="col-md-3 mb-3">
                                        <label for="email_contact" class="form-label">
                                            <i class="fa fa-envelope me-1"></i>E-mail de contacto
                                        </label>
                                        <input type="text" class="form-control" id="email_contact" placeholder="Email" value="<?php echo $email_contact;?>" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-4 mb-3">
                                        <label for="condiciones" class="form-label">
                                            <i class="fa fa-credit-card me-1"></i>Condiciones de pago
                                        </label>
                                        <input type="text" class="form-control" id="condiciones" placeholder="Condiciones de pago" value="<?php echo $condiciones;?>" onblur="update_cotizacion(2,this.value);">
                                    </div>
                                    
                                    <div class="col-md-4 mb-3">
                                        <label for="validez" class="form-label">
                                            <i class="fa fa-calendar me-1"></i>Validéz de la oferta
                                        </label>
                                        <input type="text" class="form-control" id="validez" placeholder="Validéz de la oferta" value="<?php echo $validez;?>" onblur="update_cotizacion(3,this.value);">
                                    </div>
                                    
                                    <div class="col-md-4 mb-3">
                                        <label for="entrega" class="form-label">
                                            <i class="fa fa-truck me-1"></i>Tiempo de entrega
                                        </label>
                                        <input type="text" class="form-control" id="entrega" placeholder="Tiempo de entrega" value="<?php echo $entrega;?>" onblur="update_cotizacion(4,this.value);">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-4">
                                    <div class="col-md-5 mb-3">
                                        <label for="notas" class="form-label">
                                            <i class="fa fa-sticky-note me-1"></i>Nota
                                        </label>
                                        <input type="text" class="form-control" id="notas" placeholder="Nota adicional" maxlength='255' value="<?php echo $notas?>" onblur="update_cotizacion(5,this.value);">
                                    </div>
                                    
                                    <div class="col-md-2 mb-3">
                                        <label for="id_plantilla" class="form-label">
                                            <i class="fa fa-file me-1"></i>Plantilla
                                        </label>
                                        <?php
                                            $sql_plantillas=mysqli_query($con,"select * from plantillas order by id asc");
                                        ?>
                                        <select name="id_plantilla" id="id_plantilla" class='form-select' onchange="update_cotizacion(9,this.value);">
                                        <?php 
                                            while ($rwP=mysqli_fetch_array($sql_plantillas)){
                                                $id_plantilla=$rwP['id'];
                                                $plantilla=$rwP['name'];
                                                $status_plantilla=$rwP['status'];
                                                if ($id_plantilla==$template){$s1="selected";}
                                                else {$s1="";}
                                    ...
                                    <div class="col-md-2 mb-3">
                                        ...
                                        <select class="form-select" id="status" required onchange="update_cotizacion(6,this.value);">
                                            ...
                                            <option value='2' <?php if($status==2){echo "selected";}?>>En Ejecución</option>
                                            <option value='3' <?php if($status==3){echo "selected";}?>>Pagada</option>
                                            <option value='4' <?php if($status==4){echo "selected";}?>>Nula</option>
                                        </select>
                                    </div>
                                    
                                    <div class="col-md-3 mb-3">
                                        <label for="moneda" class="form-label">
                                            <i class="fa fa-money-bill me-1"></i>Moneda
                                        </label>
                                        <select name="moneda" id="moneda" class='form-select' onchange="update_cotizacion(7,this.value);">
                                            <?php 
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-end gap-2">
                                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">
                                                <i class="fa fa-search me-1"></i> Buscar productos
                                            </button>
                                            <button type="button" class="btn btn-light" onclick="ver_cotizacion('<?php echo $id_cotizacion;?>');">
