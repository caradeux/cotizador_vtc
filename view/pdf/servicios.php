...
<table cellspacing="0" style="width: 100%; text-align: left; font-size:14px;margin-top:10px">
  ...
  <br>
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;" class='productos'>
        <tr>
           
			<th style="width: 80%" class='class-theme'>DESCRIPCION</th>
...
while ($row=mysqli_fetch_array($sql))
	...
	?>
        ...
        <tr>
            ...
            <td class='<?php echo $clase;?> ' style="width: 80%; text-align: left"><?php echo $nombre_producto;?></td>
