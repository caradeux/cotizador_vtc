...
<page backtop="10mm" backbottom="10mm" backleft="10mm" backright="10mm" style="font-size: 12px; font-family: helvetica" >
        ...
        <tr style="vertical-align: top">
			...
			<td style="width:100%;text-align:center">
				...
				<?php 
					...
					elseif ($estado==2){$lbl_status= "COTIZACIONES EN EJECUCIÓN";}
					elseif ($estado==3){$lbl_status= "COTIZACIONES PAGADAS";}
					elseif ($estado==4){$lbl_status= "COTIZACIONES NULAS";}
					echo $lbl_status;
					}
				?>
				</span>
    ...
    <table class="table-bordered" style="width:100%;font-size:10px" cellspacing=0>
        <tr>
            ...
            <th class="bottom left" style="width: 10%;text-align:center">Fecha</th>
            <th class="bottom left" style="width: 25%;text-align:left">Contacto</th>
			<th class="bottom left" style="width: 30%;text-align:left">Cliente</th>
            <th class="bottom left" style="width: 15%;text-align:left">Vendedor</th>
			<th class="bottom left" style="width: 15%;text-align:right">Total</th>
	...
	<?php
		...
		while ($row=mysqli_fetch_array($query)){
			...
			?>
		<tr>
            <td class="" style="width: 5%; text-align: center"><?php echo $numero_cotizacion;?>000</td>
            <td class="left" style="width: 10%; text-align: center"><?php echo $fecha;?></td>
			...
			<td class="left" style="width: 15%;text-align:right"><?php   echo $symbol." ".number_format($monto_total,$decimals,$decimal_separator,$thousand_separator);?></td>
