...
<page backtop="0mm" backbottom="0mm" backleft="0mm" backright="0mm" style="font-size: 12pt; font-family: arial" >
    <page_header>
        <table class="page_header" cellspacing=0 cellpadding=0 >
            <tr>
                ...
                <td style="width: 30%;text-align:center;max-height:100px" class='white' rowspan='2'>
                    <?php 
				if (!empty($logo_url) && file_exists($logo_url)){
					...
					if ($image_info !== false) {
						?>
						<img style="width: 100%;padding:5px; max-height: 80px; object-fit: contain;" src="<?php echo $logo_url;?>" alt="Logo" ><br>
						<?php 
					} else {
						?>
						<div style="width: 100%; height: 80px; background-color: #f8f9fa; display: flex; align-items: center; justify-content: center; border: 1px solid #dee2e6; border-radius: 4px; padding: 5px;">
                ...
                <td style="width: 23%; text-align: center;vertical-align:middle;border-left:#e74c3c 3px;" >
                    <img src="assets/images/icon/phone.png" style="width:15%">
                </td>
				<td style="width: 23%; text-align: center;vertical-align:middle" >
                    <img src="assets/images/icon/mail.png" style="width:15%">
                </td>
				<td style="width: 23%; text-align: center;vertical-align:middle" >
                    <img src="assets/images/icon/home.png" style="width:15%">
                </td>
            </tr>
	...
	<page_footer>
        <table class="page_footer" cellspacing=0 cellpadding=0 >
            <tr>
                ...
                <td style="width: 27%; text-align: center;vertical-align:middle;" class='orange-top'>
				...
				<td style="width: 19%; text-align: left;" class='orange-top orange-left' >
                    <?php 
					if (!empty($logo_url) && file_exists($logo_url)){
						// Verificar si la imagen es válida
						$image_info = @getimagesize($logo_url);
	...
	<table cellspacing="0" style="width: 100%; text-align: left; font-size:14px;margin-top:120px">
		<tr>
			<td style="width:5%;"> </td>
			<td colspan='2' style="width:90%;font-size:24px;text-align:center;padding:6px"><b><?php echo $nombre_empresa;?>  </b></td>
			<td style="width:5%;"> </td>
		</tr>
		
		<tr>
			<td style="width:5%;"> </td>
			<td style="width:70%;font-size:24px;color:#e74c3c"><b>COTIZADO A </b></td>
			<td style="width:20%;text-align:right">
				<span style="color:#e74c3c">COTIZACIÓN #:</span> <?php echo $numero_cotizacion;?>
			</td>
			<td style="width:5%;"> </td>
		</tr>
		...
		<tr>
			...
			<td style="width:20%;text-align:right;">
				<span style="color:#e74c3c">FECHA:</span> <?php echo $fecha_cotizacion;?>
			</td>
			<td style="width:5%;"> </td>
		</tr>
	</table>
	...
	<?php 
		$total_cotizado=$rwC['total_iva']+$rwC['total_neto'];
	?>
	<table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;margin-top:20px">
		<tr>
			<td style="width:5%;"> </td>
			<td style="width:70%;font-size:24px;"><b>TOTAL <?php echo $moneda;?> </b> <?php echo number_format($total_cotizado,$decimals,$dec_point, $thousands_sep);?></td>
			<td style="width:20%;font-size:24px;text-align:center;background-color:#eee;padding:10px"><b>COTIZACIÓN  </b></td>
...
?>
	...
	<?php }?>	
		...
		<tr>
			...
			<td style="width:15%;font-size:14px;text-align:right;padding:5px" class='border-bottom border-right'><?php echo number_format($total_cotizacion,$decimals, $dec_point, $thousands_sep);?></td>
			<td style="width:5%;font-size:24px;text-align:center;"></td>
		</tr>
	...
	<br>
          <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
            <tr>
				<td style="width:20%;border-right: 2px solid #e74c3c"> </td>
                <td style="width:80%;text-align:left;font-family: helvetica;color:#e74c3c;padding:15px" colspan=2><b>CONDICIONES Y FORMA DE PAGO</b> </td>
