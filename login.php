            ...
            <div class="card-body">
                ...
                <form class="form-horizontal form-material" id="loginform" action="login.php" method="post">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" required="" name="user_name" placeholder="Usuario"> </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
                            <input class="form-control" type="password" name="user_password" required="" placeholder="Contraseña"> </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="checkbox checkbox-primary float-left pt-0">
                               
                            </div> <a href="recovery.php"  class="text-dark float-right"><i class="fa fa-lock mr-1"></i> Olvidaste tu contraseña?</a> </div>
                    </div>
