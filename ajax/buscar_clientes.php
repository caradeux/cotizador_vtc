              ...
              <table class="table table-hover">
                <thead class="table-light">
                  <tr>
                    ...
                    <th scope="col">Nº registro fiscal</th>
				...
				while ($row=mysqli_fetch_array($query)){
                    ...
                    <tr>
                        <td><strong class="text-primary"><?php echo $id_cliente; ?></strong></td>
                        ...
                        <div class="dropdown dropleft">
                              ...
                              <div class="dropdown-menu dropdown-menu-right shadow">
								...
								<a class="dropdown-item" href="#" title='Editar cliente' onclick="obtener_datos('<?php echo $id_cliente;?>');" data-toggle="modal" data-target="#myModal2"><i class="fa fa-edit"></i> Editar</a>
								<a class="dropdown-item" href="#" title='Agregar contacto'  data-toggle="modal" data-id="<?php echo $id_cliente;?>" data-cliente="<?php echo $nombre_cliente;?>" data-target="#agregar"><i class="fa fa-user"></i> Agregar contacto</a>
								<?php }
										if ($permisos_eliminar==1){
								?>
                                <a class="dropdown-item text-danger" href="#" title='Borrar cliente' onclick="eliminar('<?php echo $id_cliente; ?>')" ><i class="fa fa-trash"></i> Eliminar</a>
								<?php }?>
							  </div>
						</div>
						</td>
