<?php
	...
	if (empty($_POST['cliente'])) {
		...
		$sql="INSERT INTO clients (nombre_cliente, nombre_comercial, numero_identificacion,giro,contacto, direccion, email, fijo, movil, fecha_agregado) VALUES ('$cliente','$nombre_comercial','$registro','$giro','','$direccion','$email','$fijo','','$date_added')";
